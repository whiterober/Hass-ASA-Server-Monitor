    ...
    if ttype == 'reference_table':
        ...
        for block in tab.get('content_blocks',[]):
            ...
            if bt=='text':
                ...
                # _default: flip auto-color class (bg/text use var(--primary-text-color) theme-adaptive)
                if blk_active == '_default' and blk_st in (1, 2):
                        ...
                        for icon in ig_icons:
                            ...
                            if iac != 'off':
                                ...
                                if ilum is not None and ilum != 0.5:
                                    ...
                                    ac_cls = ' ic-auto-dark'
                                # _default: flip auto-color class (bg/text use theme-adaptive var)
                                if (block_maps and '_default' in block_maps) or (linear_maps and '_default' in linear_maps):
