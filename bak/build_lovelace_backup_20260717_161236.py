...
def make_ic_css(server_map, fixed_styles_map):
    ...
    IC_CSS += 'ha-card .ig-title-badge{display:inline-flex!important;align-items:center!important;padding:2px 6px!important;border-radius:6px!important;background:color-mix(in srgb,var(--primary-color) 15%,transparent)!important;color:var(--primary-text-color)!important;line-height:1!important}'
    IC_CSS += 'ha-card .ig-row-wrapper{font-size:0.9em!important}'
    IC_CSS += 'ha-card .ig-title-row{font-size:0.85em!important}'
