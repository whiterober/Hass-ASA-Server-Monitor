...
def make_ic_css(server_map, fixed_styles_map):
    ...
    IC_CSS += 'ha-card .ig-title-badge{display:inline-flex!important;align-items:center!important;font-size:0.65em!important;padding:2px 6px!important;border-radius:6px!important;background:color-mix(in srgb,var(--primary-color) 15%,transparent)!important;color:var(--primary-text-color)!important;line-height:1.3!important}'
    IC_CSS += 'ha-card .ig-title-row ha-icon{flex-shrink:0!important;align-self:center!important}'
    IC_CSS += 'ha-card .ig-title-row > span ha-icon{vertical-align:middle!important}'
...
if __name__ == "__main__":
    ...
    def make_content_card(html_content, tab_type=None, tab=None):
        if tab_type == 'mixed_content' and tab:
            ...
            css += 'ha-card .ic-copy-key ha-icon{vertical-align:middle!important;color:var(--primary-background-color)!important}'
