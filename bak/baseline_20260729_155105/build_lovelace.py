...
def make_ic_css(server_map, fixed_styles_map):
    ...
    IC_CSS += 'ha-card .ic-text:not([class*="ic-block-"]) .ic-qty{display:inline-flex!important;align-items:center!important;gap:1px!important;padding:1px 6px!important;border-radius:10px!important;background:color-mix(in srgb,var(--primary-color) 25%,transparent)!important;color:var(--primary-text-color)!important;line-height:1.5!important}'
    for sid, sm in server_map.items():
        ...
        _srgb = 'rgb({},{},{})'.format(r, g, b)
        IC_CSS += 'ha-card .ic-text.ic-block-{0} .ic-qty{{position:absolute!important;right:0!important;bottom:0!important;color:var(--primary-background-color)!important;font-size:0.8em!important;padding:1px 5px!important;border-radius:4px 0 0 0!important;-webkit-text-stroke:2px '+_srgb+'!important;paint-order:stroke fill!important}}'.format(sid)
        ...
        IC_CSS += 'ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-badge:has(.ic-block-img) .ic-qty,ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-row:has(.ic-block-img) .ic-qty{{padding:1px 5px!important;border-radius:4px 0 0 0!important;color:var(--primary-background-color)!important;-webkit-text-stroke:2px '+_srgb+'!important;paint-order:stroke fill!important}}'.format(sid)
        IC_CSS += 'ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-badge:has(.ic-block-img-before) .ic-qty,ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-row:has(.ic-block-img-before) .ic-qty{{padding:1px 5px!important;border-radius:0 4px 0 0!important;color:var(--primary-background-color)!important;-webkit-text-stroke:2px '+_srgb+'!important;paint-order:stroke fill!important}}'.format(sid)
    ...
    for fk, fv in fixed_styles_map.items():
        ...
        IC_CSS += 'ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-badge:has(.ic-block-img) .ic-qty,ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-row:has(.ic-block-img) .ic-qty{{'+_qty_color_rule+'padding:1px 5px!important;border-radius:4px 0 0 0!important;font-size:0.8em!important;-webkit-text-stroke:2px '+_stroke_col+'!important;paint-order:stroke fill!important}}'.format(fk)
        IC_CSS += 'ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-badge:has(.ic-block-img-before) .ic-qty,ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-row:has(.ic-block-img-before) .ic-qty{{'+_qty_color_rule+'padding:1px 5px!important;border-radius:0 4px 0 0!important;font-size:0.8em!important;-webkit-text-stroke:2px '+_stroke_col+'!important;paint-order:stroke fill!important}}'.format(fk)
