...
def main():
    ...
    if ttype == 'raw_html':
        ...
        # _default badge-hollow auto: only when color=auto
        css += '[data-theme="dark"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(0,0,0,0.15)!important}'
        css += '[data-theme="light"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(255,255,255,0.15)!important}'
        css += '[data-theme="dark"] ha-card .ic-text.ic-auto-block .ic-qty{-webkit-text-stroke:2px var(--primary-text-color)!important}'
        css += '[data-theme="light"] ha-card .ic-text.ic-auto-block .ic-qty{-webkit-text-stroke:2px var(--primary-text-color)!important}'
        css += '[data-theme="dark"] ha-card .ic-text.ic-block-_default:not(.ic-auto-block) .ic-qty{-webkit-text-stroke:2px var(--primary-background-color)!important}'
        css += '[data-theme="light"] ha-card .ic-text.ic-block-_default:not(.ic-auto-block) .ic-qty{-webkit-text-stroke:2px var(--primary-background-color)!important}'
