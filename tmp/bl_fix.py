        ...
        if tab_type == 'mixed_content' and tab:
            ...
            if 'info_card' in block_types:
                ...
                for fk, fv in FIXED_STYLES_MAP.items():
                    ...
                    if fk == '_default':
                        IC_CSS += '[data-theme="dark"] ha-card .ic-text.ic-block-_default{background:rgba(255,255,255,0.1)!important;border-radius:6px!important;padding:2px 6px!important;color:var(--primary-background-color)!important}'
                        IC_CSS += '[data-theme="light"] ha-card .ic-text.ic-block-_default{background:rgba(0,0,0,0.1)!important;border-radius:6px!important;padding:2px 6px!important;color:var(--primary-background-color)!important}'
                    else:
