...
def make_ic_css(server_map, fixed_styles_map):
    ...
    for sid, sm in server_map.items():
        ...
        IC_CSS += 'ha-card .ic-text.ic-block-{0} .ic-qty{{position:absolute!important;right:0!important;bottom:0!important;color:var(--primary-background-color)!important;font-size:0.8em!important;padding:1px 5px!important;border-radius:4px 0 0 0!important;-webkit-text-stroke:2px rgb('+str(r)+','+str(g)+','+str(b)+')!important;paint-order:stroke fill!important}}'.format(sid)
        ...
        IC_CSS += 'ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-badge:has(.ic-block-img) .ic-qty,ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-row:has(.ic-block-img) .ic-qty{{padding:1px 5px!important;border-radius:4px 0 0 0!important;color:var(--primary-background-color)!important;-webkit-text-stroke:2px rgb('+str(r)+','+str(g)+','+str(b)+')!important;paint-order:stroke fill!important}}'.format(sid)
        IC_CSS += 'ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-badge:has(.ic-block-img-before) .ic-qty,ha-card .ig-row-wrapper.ic-linear-{0} .ig-title-row:has(.ic-block-img-before) .ic-qty{{padding:1px 5px!important;border-radius:0 4px 0 0!important;color:var(--primary-background-color)!important;-webkit-text-stroke:2px rgb('+str(r)+','+str(g)+','+str(b)+')!important;paint-order:stroke fill!important}}'.format(sid)
