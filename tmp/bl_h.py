    ...
    def make_content_card(html_content, tab_type=None, tab=None):
        if tab_type == 'mixed_content' and tab:
            ...
            if 'info_card' in block_types:
                ...
                IC_CSS += 'ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:color-mix(in srgb,var(--primary-text-color) 30%,transparent)!important}'
