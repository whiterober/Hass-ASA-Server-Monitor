    ...
    def make_content_card(html_content, tab_type=None, tab=None):
        if tab_type == 'mixed_content' and tab:
            ...
            if 'info_card' in block_types:
                ...
                IC_CSS += '[data-theme="dark"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(0,0,0,0.3)!important}'
                IC_CSS += '[data-theme="light"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(255,255,255,0.3)!important}'
                # qty stroke: auto = text color
                ...
                # non-auto _default qty stroke = block background color
