...
ha-card .info-card-block img.ic-auto-dark { filter: none; }
ha-card .info-card-block img.ic-auto-light { filter: none; }
[data-theme="dark"] ha-card .info-card-block img.ic-auto-dark { filter: invert(1); }
[data-theme="light"] ha-card .info-card-block img.ic-auto-light { filter: invert(1); }
    ...
    def make_content_card(html_content, tab_type=None, tab=None):
        if tab_type == 'mixed_content' and tab:
            ...
            if 'info_card' in block_types:
                ...
                # _default badge-hollow: match specificity with [class*="ic-block-"] rule
                IC_CSS += '[data-theme="dark"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(0,0,0,0.15)!important}'
                IC_CSS += '[data-theme="light"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(255,255,255,0.15)!important}'
                # qty stroke: auto = text color, non-auto = background color
                IC_CSS += '[data-theme="dark"] ha-card .ic-text.ic-auto-block .ic-qty{-webkit-text-stroke:2px var(--primary-text-color)!important}'
                IC_CSS += '[data-theme="light"] ha-card .ic-text.ic-auto-block .ic-qty{-webkit-text-stroke:2px var(--primary-text-color)!important}'
                IC_CSS += '[data-theme="dark"] ha-card .ic-text.ic-block-_default:not(.ic-auto-block) .ic-qty{-webkit-text-stroke:2px var(--primary-background-color)!important}'
                IC_CSS += '[data-theme="light"] ha-card .ic-text.ic-block-_default:not(.ic-auto-block) .ic-qty{-webkit-text-stroke:2px var(--primary-background-color)!important}'
