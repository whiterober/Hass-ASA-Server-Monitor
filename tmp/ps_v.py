...
def main():
    ...
    if ttype == 'raw_html':
        ...
        css += '[data-theme="dark"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(0,0,0,0.3)!important}'
        css += '[data-theme="light"] ha-card .ic-text.ic-auto-block .ic-badge-hollow{color:var(--primary-text-color)!important;background:rgba(255,255,255,0.3)!important}'
